...
export const PlainRoom:React.FC<PlainRoomProps> = ({ room, isRich, addToHidden }) => {
  ...
  return (
    <div className="w-full flex flex-col p-2 flex-nowrap border rounded" onClick={toRoom}>
      { isRich && <img src={room.snapshot}></img> }
